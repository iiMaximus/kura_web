...
- Submit only to directories with a real audience, editorial standards, and relevant categories.
- Do not pay for links unless the value is brand exposure and the link is disclosed or nofollow where appropriate.
- Do not create fake reviews, fake founder accounts, or duplicate listings.
- Keep the product description consistent across directories.
- Check every claim against the current app before submitting.
...
- Screenshots: food scan, ingredient view, cosmetics/beauty scan, App Store screenshot.
- Short description: use `docs/seo/app-description-boilerplate.md`.
- Long description: use `docs/seo/app-description-boilerplate.md`.
- Privacy URL: {Privacy URL}.
- Terms URL: {Terms URL}.
- Pricing: core scanning is free, if still accurate.
- Launch date: {Launch date}.
- Founder/company: {Founder or company name}.
...
1. App launch and discovery platforms.
2. iOS app review sites and newsletters.
3. Startup launch directories.
4. Food, nutrition, and ingredient-literacy resource lists.
5. Beauty and cosmetics ingredient resource lists.
...
Use a simple UTM scheme when allowed:

```text
?utm_source={directory-slug}&utm_medium=directory&utm_campaign=backlinks-ai-visibility
```
...
| Date | Directory | Category | URL Submitted | Description Version | Status | Notes |
| --- | --- | --- | --- | --- | --- | --- |
| YYYY-MM-DD | {Directory} | {Category} | {URL} | Short v1 | Submitted | {Notes} |
...
- Record whether the link is followed, nofollow, sponsored, or redirect-only.
- Save a screenshot or listing URL.
- Add the listing to AI prompt monitoring if the directory is likely to be cited.

## Monthly Cleanup

- Remove or update inaccurate listings.
- Refresh screenshots if the app UI changes.
- Replace "new" language after launch momentum fades.
- Check for broken App Store, privacy, and terms links.
- Review referral traffic and conversion quality.
