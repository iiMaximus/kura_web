...
Kura's final production domain is not set yet. Resolve these paths against the current live deployment URL until the final domain is purchased and configured.
